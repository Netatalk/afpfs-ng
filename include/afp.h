...
#define is_netatalk(x) ( (x)->server_type == AFPFS_SERVER_TYPE_NETATALK )
#define is_airport(x) ( (x)->server_type == AFPFS_SERVER_TYPE_AIRPORT )
#define is_macintosh(x) ( (x)->server_type == AFPFS_SERVER_TYPE_MACINTOSH )
#define is_timecapsule(x) ( (x)->server_type == AFPFS_SERVER_TYPE_TIMECAPSULE )
